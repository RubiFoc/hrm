"""Persistence model for asynchronous match scoring jobs."""
...
class MatchScoringJob(Base):
    """Asynchronous scoring job state for one vacancy-candidate-document tuple.

    Attributes:
        job_id: Unique scoring job identifier.
        vacancy_id: Linked vacancy identifier.
        candidate_id: Linked candidate profile identifier.
        document_id: Linked active candidate document identifier used for scoring.
    ...
    __tablename__ = "match_scoring_jobs"
    __table_args__ = (
        Index("ix_match_scoring_jobs_status", "status"),
        Index("ix_match_scoring_jobs_queued_at", "queued_at"),
        Index("ix_match_scoring_jobs_vacancy_id", "vacancy_id"),
        Index("ix_match_scoring_jobs_candidate_id", "candidate_id"),
        Index("ix_match_scoring_jobs_document_id", "document_id"),
        Index(
